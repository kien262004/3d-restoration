...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument("--netG", type=str, default="resnet_9blocks", help="specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128 | unet64 | unet32]")
