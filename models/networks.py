...
def define_G(input_nc, output_nc, netG, norm="batch", use_dropout=False, init_type="normal", init_gain=0.02):
    """Create a generator
    ...
    net = None
    if netG == 'unet':
        net = UnetGenerator(input_nc, output_nc, dim=48, num_layers=3)
...
class UnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, dim=48, num_layers=3):
        super().__init__()
        
        self.embed = OverlapPatchEmbed(input_nc, dim)
        self.recon = nn.Conv2d(dim, output_nc, 3, 1, 1)
